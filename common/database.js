...
const defaults = {
  ...
  cars: [
    {
      ...
      type: 'SUV',
      status: 'idle',
      currentMileage: 23540,
      maintainDate: '2025-12-18',
      insuranceDue: '2026-03-15',
      usingInfo: null,
    },
    {
      carId: 'car-2',
      ...
      type: '轿车',
      status: 'using',
      currentMileage: 17890,
      maintainDate: '2025-11-20',
      insuranceDue: '2026-02-10',
      usingInfo: {
        user: '李警官',
        startTime: '2026-01-30 02:44',
        startMileage: 17860,
        purpose: '出警',
        destination: '桂南路段',
        relatedIncidentId: 'JJ202601300236',
      },
    },
    {
      carId: 'car-3',
      ...
      maintainDate: '2025-10-06',
      insuranceDue: '2025-12-30',
      maintainReason: '轮胎检修',
      maintainRecoverAt: '2025-08-08 18:00',
      usingInfo: null,
    },
    {
      carId: 'car-4',
      ...
      status: 'idle',
      currentMileage: 9650,
      maintainDate: '2025-09-10',
      insuranceDue: '2026-05-01',
      usingInfo: null,
    },
  ],
  handworkRecords: [],
  carUseLogs: [
    ...
    },
    {
      ...
      purpose: '出警',
      destination: '江北市场',
      startTime: '2025-07-28 19:40',
      startMileage: 17690,
      endTime: '2025-07-28 22:10',
      endMileage: 17740,
      distance: 50,
      status: 'CLOSED',
      relatedIncidentId: 'JJ202507280912',
    },
    {
      id: 'carlog-3',
      carId: 'car-2',
    ...
    },
    {
      ...
      purpose: '巡逻',
      destination: '桂南社区',
      startTime: '2025-07-25 09:10',
      startMileage: 23480,
      endTime: '2025-07-25 12:20',
      endMileage: 23520,
      distance: 40,
      status: 'CLOSED',
      relatedIncidentId: '',
    },
    {
      ...
      purpose: '出警',
      destination: '桂南路口',
      startTime: '2025-07-18 08:40',
      startMileage: 23390,
      endTime: '2025-07-18 11:05',
      endMileage: 23440,
      distance: 50,
      status: 'CLOSED',
      relatedIncidentId: 'JJ202507180836',
    },
    {
      id: 'carlog-6',
      carId: 'car-3',
      ...
      purpose: '送检',
      destination: '车辆维修点',
      startTime: '2025-07-10 14:20',
      startMileage: 41120,
      endTime: '2025-07-10 16:10',
      endMileage: 41150,
      distance: 30,
      status: 'CLOSED',
      relatedIncidentId: '',
    },
    {
      ...
      purpose: '走访',
      destination: '江北社区',
      startTime: '2025-07-22 10:15',
      startMileage: 9570,
      endTime: '2025-07-22 13:00',
      endMileage: 9615,
      distance: 45,
      status: 'CLOSED',
      relatedIncidentId: '',
    },
    {
      ...
      purpose: '巡逻',
      destination: '龙石路段',
      startTime: '2025-07-12 19:30',
      startMileage: 9480,
      endTime: '2025-07-12 22:20',
      endMileage: 9520,
      distance: 40,
      status: 'CLOSED',
      relatedIncidentId: '',
    },
    {
      ...
      purpose: '押送',
      destination: '看守所',
      startTime: '2025-07-02 20:10',
      startMileage: 41040,
      endTime: '2025-07-02 23:00',
      endMileage: 41090,
      distance: 50,
      status: 'CLOSED',
      relatedIncidentId: 'JJ202507021910',
    },
    {
      id: 'carlog-10',
      carId: 'car-1',
      ...
      purpose: '巡逻',
      destination: '桂南商圈',
      startTime: '2025-07-05 18:30',
      startMileage: 23320,
      endTime: '2025-07-05 20:10',
      endMileage: 23360,
      distance: 40,
      status: 'CLOSED',
      relatedIncidentId: '',
...
export const getCarById = (carId) => getCars().find((c) => c.carId === carId);

export function updateCar(carId, patch) {
  const list = getCars().map((c) => (c.carId === carId ? { ...c, ...patch } : c));
  saveCars(list);
  return list;
}
