...
const mockRecords = [
  {
    visitId: 'mock-1',
    content: '检查包间卫生与消防设施，情况正常。',
    visitType: '例行检查',
    visitAt: '2025-09-15 16:10',
    visitorName: '张三',
  },
  {
    visitId: 'mock-2',
    content: '从业人员证件核验，记录齐全。',
    visitType: '证件核验',
    visitAt: '2025-09-01 20:30',
    visitorName: '李四',
  },
  {
    visitId: 'mock-3',
    content: '排查涉黄风险，暂未发现问题。',
    visitType: '专项检查',
    visitAt: '2025-08-23 11:50',
    visitorName: '王五',
  },
];
...
function buildArchiveItems() {
  ...
  items.push({
    ...
    itemType: 'BASIC',
    title: '基础信息',
    subTitle: `包间 ${primary.roomCount || '--'}｜从业 ${primary.staffCount || '--'}｜涉黄 ${primary.riskPornFlag ? '是' : '否'}｜营业 ${primary.businessHours || '--'}`,
    rightText: '',
    payload: {
...
function handleAction() {
  ...
  if (activeTab.value === 'staff') {
    uni.showToast({ title: '新增人员', icon: 'none' });
    return;
  }
