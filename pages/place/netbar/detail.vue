<template>
  <view class="place-detail pageBg">
    ...
    <view class="card" v-if="place">
      ...
      <view class="row"><text class="label">类型</text><text class="value">网吧</text></view>
    ...
    <view class="card" v-if="profile">
      ...
      <view class="row"><text class="label">机位数</text><text class="value">{{ profile.primary.seatCount }}</text></view>
      <view class="row"><text class="label">实名系统</text><text class="value">{{ profile.primary.realNameSystem }}</text></view>
      <view class="row"><text class="label">未成年人管控</text><text class="value">{{ profile.primary.minorControl }}</text></view>
      <view class="row"><text class="label">营业时间</text><text class="value">{{ profile.primary.businessHours }}</text></view>
      <view class="row"><text class="label">监控情况</text><text class="value">{{ profile.primary.hasCCTV ? '正常' : '缺失' }}</text></view>
    </view>
